# Vendored from https://github.com/shiyu-coder/Kronos (commit 67b630e, model/kronos.py).
# Copyright (c) 2025 ShiYu. MIT License; see agent/kronos/LICENSE.
# Changes: sys.path hack removed and model.module import made package-relative; code otherwise unchanged.
